...
class Type_edit extends StatefulWidget {
  Type_edit({Key key, this.nomer, this.name, this.type, this.subtype, this.title}) : super(key: key);
  final String title;
  final String nomer;
  final String name;
  final String type;
  ...
  @override
  _Type_edit createState() => _Type_edit();
}

class _Type_edit extends State<Type_edit> {
...
;                        events.doc(i.toString()).update({
      ...
      //                  context,
      //                  MaterialPageRoute(
      //                      builder: (context) => Home_types(title: "Home Page")),
      //                );
      //              },
      //              child: Text('Отмена'),
      //            ),
