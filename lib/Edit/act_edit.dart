...
class ActEdit1 extends StatefulWidget {
  ActEdit1({Key key, this.nom, this.id, this.name,  this.type,  this.event,  this.description,  this.url, this.description2, this.url2, this.description3, this.url3, this.title}) : super(key: key);
  final dynamic title;
  final dynamic id;
  final dynamic nom;
  final dynamic name;
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
            ...
            children: <Widget>[
              ActEdit(nom: widget.nom, id: widget.id, name: widget.name, type: widget.type, event: widget.event, description: widget.description, description2: widget.description2, description3: widget.description3, url: widget.url, url2: widget.url2, url3: widget.url3, title: widget.title),
            ]),
      )),
    );
  }
...
class ActEdit extends StatefulWidget {
  ActEdit({Key key, this.nom, this.id, this.name, this.type, this.event, this.description, this.url, this.description2, this.url2, this.description3, this.url3, this.title}) : super(key: key);
  final dynamic nom;
  final dynamic id;
  final dynamic name;
  final dynamic type;
...
class _ActEdit1State extends State<ActEdit> {
  ...
  Widget build(BuildContext context) {
    ...
    final _descriptionController2 = TextEditingController(text: widget.description2);
    final _descriptionController3 = TextEditingController(text: widget.description3);
...
//                  },
  ...
  //                              _pic = _url0['pic'];
              ...
              Padding(
                  padding: EdgeInsets.all(5.0),
                  child: _url3!=null ? Image.network(_url3) : Text('Нет картинки')),
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ListAccessories(title: "Аксессуары", id: widget.id, name: widget.name)),
                      );
