...
class PictureEdit extends StatefulWidget {
  PictureEdit({Key? key, this.nom, this.id, this.name, this.title, this.url})
      : super(key: key);
  final dynamic title;
  final dynamic nom;
  final dynamic id;
  ...
  @override
  _PictureEdit createState() => _PictureEdit();
}

class _PictureEdit extends State<PictureEdit> {
  @override
